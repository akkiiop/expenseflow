...
**React 19** • **Spring Boot 4.1** • **Java 21** • **MySQL 8.0** • **Google Gemini 2.5 Flash** • **AWS EC2**

> 🚀 **Live Production Deployment:** [https://www.expenseflow.dev/](https://www.expenseflow.dev/)

[Explore Live Application](https://www.expenseflow.dev/) • [Backend Source](backend/) • [Frontend Source](frontend/)
...
| Public Landing Page | Financial Dashboard |
|:---:|:---:|
| ![ExpenseFlow Landing Page](docs/images/landing-page.png) | ![ExpenseFlow Dashboard](docs/images/dashboard.png) |

<div align="center">

| Financial Reports & Trends |
|:---:|
| ![ExpenseFlow Reports](docs/images/reports.png) |
...
Built with a **React 19** frontend and a **Spring Boot 4.1** REST backend backed by **MySQL 8.0**, ExpenseFlow implements stateless JWT authentication, user-isolated data storage, and direct cloud integration with Google Gemini.

---

## 💡 How It Works

1. **Authenticate**: Register or log in to generate an encrypted password session backed by stateless JWT authentication.
2. **Track Cash Flows**: Log income streams and categorize daily expenses with payment methods (UPI, Cash, Card) and transaction dates.
3. **Set Category Budgets**: Define monthly budget limits per category and monitor real-time spending progress bars with threshold alerts.
4. **Analyze & Optimize**: Review financial summaries across periods and receive personalized spending tips generated by Google Gemini 2.5 Flash.
...
- **Modern React Frontend**: React 19 SPA built with Vite 8, React Router v7, and custom responsive CSS.
- **AI Integration**: Native Java 21 `HttpClient` integration calling Google's Gemini 2.5 Flash API directly.
